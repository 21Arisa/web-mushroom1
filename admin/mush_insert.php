...
$sql="INSERT INTO mushroom(mush_name,com_id,sci_name,phylum_id,family_id,cap_id,skin_id,gill_id,stalk_id,cate_id,region_id,image,mush_detail,datemonth,user_id)
VALUES('$mush_name','$last_ncom','$csi_name','$phylum_id','$familyid','$cap','$capskin','$gill','$stalk','$cate_id','$region_id','$new_image_name','$mushdetail','$datemonth','$id_user')";
