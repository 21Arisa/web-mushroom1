...
$sql = "INSERT INTO survey(date,ex_mushname,area,mush_detail,region_id,cate_id,ex_capid,ex_stalkid,ex_gillid,ex_capskinid,datemonth,user_id) 
        VALUES ('$date','$ex_mushname','$area','$mush_detail','$region_id','$cateid','$last_ex_cap','$last_ex_stalk','$last_ex_gill','$last_ex_capskin','$datemonth','$id_user')";
